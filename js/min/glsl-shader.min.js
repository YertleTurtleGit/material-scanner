'use strict';class Shader{constructor(){this.glslShader=null}bind(){null!==this.glslShader&&console.warn("Shader is already bound!");this.glslShader=new GlslShader}unbind(){this.glslShader=GlslShader.currentShader=null}purge(){null===this.glslShader?console.warn("No shader bound to purge!"):(this.glslShader.reset(),this.unbind())}}
...
uiLog("Rendering on gpu.");a=this.getFrameVAO(a);this.drawArraysFromVAO(a)}}
