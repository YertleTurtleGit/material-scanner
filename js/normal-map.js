...
class NormalMap {
    ...
    calculate(onloadCallback) {
        ...
        var red = ic.add(ic.divide(ic.divide(east, west), 2), ic.divide(ic.add(ic.divide(northeast, southwest), ic.divide(southeast, northwest)), 8));
        var green = ic.add(ic.divide(ic.divide(north, south), 2), ic.divide(ic.add(ic.divide(northeast, southwest), ic.divide(northwest, southeast)), 8));
        var blue = front;
